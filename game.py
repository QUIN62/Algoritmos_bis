...
class BattleshipGame:
    ...
    def mostrar_instrucciones(self):
        instrucciones = ("Instrucciones:\n\n"
                         ...
                         "4. Cada barco tiene varias posiciones en el tablero.\n\n"
                         "¡Buena suerte!")
    ...
    def nuevo_juego(self):
        ...
        self.reiniciar_botones()  # Reiniciar botones visuales para poder hacer clic nuevamente
    ...
    def limpiar_tablero_para_nuevo_nivel(self):
        for i in range(TABLERO_TAMANO):
            for j in range(TABLERO_TAMANO):
                self.tablero_botones[i][j].config(text="O", bg="SystemButtonFace")
        self.nuevo_juego()

    def reiniciar_botones(self):
        # Restablecer todos los botones para ser funcionales nuevamente
        for i in range(TABLERO_TAMANO):
            for j in range(TABLERO_TAMANO):
